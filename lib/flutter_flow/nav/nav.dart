...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const Dashboard5Widget() : const FirstScreenWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'AddCattle',
          path: '/AddCattle',
          builder: (context, params) => const AddCattleWidget(),
        ),
        FFRoute(
          name: 'Profile',
          path: '/pofile',
        ...
        FFRoute(
          name: 'insuranceCopy',
          path: '/insuranceCopy',
          builder: (context, params) => const InsuranceCopyWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'drlogin',
          path: '/drlogin',
          builder: (context, params) => const DrloginWidget(),
        ),
        FFRoute(
          name: 'blanknav',
          path: '/blanknav',
          builder: (context, params) => const BlanknavWidget(),
        )
